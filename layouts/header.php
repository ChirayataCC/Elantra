                ...
                <div class="col-xl-6 tf-md-hidden">
                    <nav class="box-navigation text-center">
                        <ul class="box-nav-ul d-flex align-items-center justify-content-center gap-30">
                            <li class="menu-item">
                                <a href="newarrival.php" class="item-link">New Arrivals</a>
                            </li>
                            <li class="menu-item">
                                <a href="bestseller.php" class="item-link">Best Sellers</a>
                            </li>
                            <li class="menu-item">
                                <a href="collection.php" class="item-link">Collection</a>
                            </li>
                            <li class="menu-item">
                                <a href="about-us.php" class="item-link">About Us</a>
                            </li>
                            <li class="menu-item">
                                <a href="contact.php" class="item-link">Contact Us</a>
                            </li>
                        </ul>
                    </nav>
                </div>
