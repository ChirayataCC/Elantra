...
<div class="tf-page-title my-md-5">
    <div class="container-full">
        <div class="heading text-center">Top Selling Styles</div>
        <p class="text-center text-2 text_black-2 mt_5">Browse our most popular fashion picks today</p>
    </div>
</div>
<!-- /page-title -->
        ...
        fetch('products.json')
            ...
            .then(products => {
                ...
                if (bestseller.length === 0) {
                    container.innerHTML = '<p class="no-products">No best seller item is currently available.</p>';
                    return;
                }

                const html = bestseller.map(product => {
